...
wordBBox = ocrtxt.WordBoundingBoxes(:,:)
figure;
Iname = insertObjectAnnotation(colorImage, 'rectangle', wordBBox, word);
imshow(Iname);


boxes = helperDetectText(colorImage);

% Visualize the results
figure; imshow(colorImage); title('Detected text regions')
hold on
for i=1:size(boxes,1)
